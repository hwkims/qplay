        ...
        2228: function(e, t, i) {
            ...
            function C(e) {
                return void 0 === e && (e = {}), r || (r = function(e) {
                    let {
                        userAgent: t
                    } = void 0 === e ? {} : e, i = M(), s = u(), r = s.navigator.platform, l = t || s.navigator.userAgent, a = {
                        ios: !1,
                        android: !1
                    }, n = s.screen.width, o = s.screen.height, d = l.match(/(Android);?[\s\/]+([\d.]+)?/), c = l.match(/(iPad).*OS\s([\d_]+)/), p = l.match(/(iPod)(.*OS\s([\d_]+))?/), h = !c && l.match(/(iPhone\sOS|iOS)\s([\d_]+)/), f = "MacIntel" === r;
                    return !c && f && i.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${n}x${o}`) >= 0 && ((c = l.match(/(Version)\/([\d.]+)/)) || (c = [0, 1, "13_0_0"]), f = !1), d && "Win32" !== r && (a.os = "android", a.android = !0), (c || h || p) && (a.os = "ios", a.ios = !0), a
                }(e)), r
            }
            let P = (e, t, i) => {
            ...
            function D(e) {
                ...
                r.allowTouchCallbacks && this.emit("touchMove", d), a.previousX = a.currentX, a.previousY = a.currentY, a.currentX = p, a.currentY = u;
            ...
            function G(e) {
                ...
                if (s.allowClick) {
                    ...
                    s.updateClickedSlide(e && e[0] || l.target, e), s.emit("tap click", l), u < 300 && p - r.lastClickTime < 300 && s.emit("doubleTap doubleClick", l)
                }
            ...
            let W = {
                    ...
                    update: {
                        ...
                        updateSlides: function() {
                            ...
                            let s = t.params,
                                ...
                                p = S(l, `.${t.params.slideClass}, swiper-slide`),
                            ...
                            let b = t.snapGrid.length,
                                ...
                                P = 0;
                            if (void 0 === a) return;
                            "string" == typeof E && E.indexOf("%") >= 0 ? E = parseFloat(E.replace("%", "")) / 100 * a : "string" == typeof E && (E = parseFloat(E)), t.virtualSize = -E, p.forEach(e => {
                            ...
                            O ? t.grid.initSlides(p) : t.grid && t.grid.unsetSlides();
                            ...
                            for (let r = 0; r < u; r += 1) {
                                let l;
                                if (e = 0, p[r] && (l = p[r]), O && t.grid.updateSlide(r, l, p), !p[r] || "none" !== y(l, "display")) {
                                    if ("auto" === s.slidesPerView) {
                                        k && (p[r].style[t.getDirectionLabel("width")] = "");
                                    ...
                                    } else e = (a - (s.slidesPerView - 1) * E) / s.slidesPerView, s.roundLengths && (e = Math.floor(e)), p[r] && (p[r].style[t.getDirectionLabel("width")] = `${e}px`);
                                    p[r] && (p[r].swiperSlideSize = e), m.push(e), s.centeredSlides ? (M = M + e / 2 + C / 2 + E, 0 === C && 0 !== r && (M = M - a / 2 - E), 0 === r && (M = M - a / 2 - E), .001 > Math.abs(M) && (M = 0), s.roundLengths && (M = Math.floor(M)), P % s.slidesPerGroup == 0 && h.push(M), f.push(M)) : (s.roundLengths && (M = Math.floor(M)), (P - Math.min(t.params.slidesPerGroupSkip, P)) % t.params.slidesPerGroup == 0 && h.push(M), f.push(M), M = M + e + E), t.virtualSize += e + E, C = e, P += 1
                                }
                            }
                            ...
                            if (u !== c && t.emit("slidesLengthChange"), h.length !== b && (t.params.watchOverflow && t.checkOverflow(), t.emit("snapGridLengthChange")), f.length !== T && t.emit("slidesGridLengthChange"), s.watchSlidesProgress && t.updateSlidesOffset(), t.emit("slidesUpdated"), !d && !s.cssMode && ("slide" === s.effect || "fade" === s.effect)) {
                        ...
                        updateSlidesProgress: function(e) {
                            ...
                            for (let e = 0; e < i.length; e += 1) {
                                ...
                                let d = (l + (t.centeredSlides ? this.minTranslate() : 0) - o) / (n.swiperSlideSize + a),
                                    ...
                                    f = p >= 0 && p < this.size - 1 || u > 1 && u <= this.size || p <= 0 && u >= this.size;
                    ...
                    slide: {
                        slideTo: function(e, t, i, s, r) {
                            ...
                            if (a.initialized && n !== u && (!a.allowSlideNext && (h ? S > a.translate && S > a.minTranslate() : S < a.translate && S < a.minTranslate()) || !a.allowSlidePrev && S > a.translate && S > a.maxTranslate() && (u || 0) !== n)) return !1;
                            if (n !== (p || 0) && i && a.emit("beforeSlideChangeStart"), a.updateProgress(S), l = n > u ? "next" : n < u ? "prev" : "reset", h && -S === a.translate || !h && S === a.translate) return a.updateActiveIndex(n), o.autoHeight && a.updateAutoHeight(), a.updateSlidesClasses(), "slide" !== o.effect && a.setTranslate(S), "reset" !== l && (a.transitionStart(i, l), a.transitionEnd(i, l)), !1;
                            if (o.cssMode) {
                                let e = a.isHorizontal(),
                                    i = h ? S : -S;
                                if (0 === t) {
                    ...
                    loop: {
                        ...
                        loopFix: function(e) {
                            ...
                            if (o.allowSlidePrev = !0, o.allowSlideNext = !0, o.virtual && h.virtual.enabled) {
                                i && (h.centeredSlides || 0 !== o.snapIndex ? h.centeredSlides && o.snapIndex < h.slidesPerView ? o.slideTo(o.virtual.slides.length + o.snapIndex, 0, !1, !0) : o.snapIndex === o.snapGrid.length - 1 && o.slideTo(o.virtual.slidesBefore, 0, !1, !0) : o.slideTo(o.virtual.slides.length, 0, !1, !0)), o.allowSlidePrev = c, o.allowSlideNext = p, o.emit("loopFix");
                                return
                            }
                            ...
                            if (o.__preventObserver__ = !0, requestAnimationFrame(() => {
                                ...
                                if (S.length > 0 && x) {
                                    if (void 0 === t) {
                                        ...
                                        n ? o.setTranslate(o.translate - t) : (o.slideTo(y + Math.ceil(M), 0, !1, !0), r && (o.touchEventsData.startTranslate = o.touchEventsData.startTranslate - t, o.touchEventsData.currentTranslate = o.touchEventsData.currentTranslate - t))
                                    } else if (r) {
                                    ...
                                    if (void 0 === t) {
                                        ...
                                        n ? o.setTranslate(o.translate - t) : (o.slideTo(y - C, 0, !1, !0), r && (o.touchEventsData.startTranslate = o.touchEventsData.startTranslate - t, o.touchEventsData.currentTranslate = o.touchEventsData.currentTranslate - t))
                                    } else {
                    ...
                    breakpoints: {
                        setBreakpoint: function() {
                            ...
                            let n = (a in l ? l[a] : void 0) || e.originalParams,
                                ...
                                p = n.grabCursor,
                                u = s.enabled;
                            o && !d ? (r.classList.remove(`${s.containerModifierClass}grid`, `${s.containerModifierClass}grid-column`), e.emitContainerClasses()) : !o && d && (r.classList.add(`${s.containerModifierClass}grid`), (n.grid.fill && "column" === n.grid.fill || !n.grid.fill && "column" === s.grid.fill) && r.classList.add(`${s.containerModifierClass}grid-column`), e.emitContainerClasses()), c && !p ? e.unsetGrabCursor() : !c && p && e.setGrabCursor(), ["navigation", "pagination", "scrollbar"].forEach(t => {
                            ...
                            }), u && !g ? e.disable() : !u && g && e.enable(), e.currentBreakpoint = a, e.emit("_beforeBreakpoint", n), i && (f ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !m && w ? (e.loopCreate(t), e.updateSlides()) : m && !w && e.loopDestroy()), e.emit("breakpoint", n)
                        },
            ...
            class Y {
                constructor() {
                    ...
                    let n = this;
                    n.__swiper__ = !0, n.support = M(), n.device = C({
                ...
                destroy(e, t) {
                    ...
                    return void 0 === i.params || i.destroyed || (i.emit("beforeDestroy"), i.initialized = !1, i.detachEvents(), s.loop && i.loopDestroy(), t && (i.removeClasses(), r.removeAttribute("style"), l.removeAttribute("style"), a && a.length && a.forEach(e => {
            ...
            let el = (0, a.createContext)(null),
                ...
                en = (0, a.forwardRef)(function(e, t) {
                    ...
                    let {
                        ...
                        onSwiper: o,
                        ...d
                    } = void 0 === e ? {} : e, c = !1, [p, u] = (0, a.useState)("swiper"), [h, f] = (0, a.useState)(null), [m, v] = (0, a.useState)(!1), g = (0, a.useRef)(!1), w = (0, a.useRef)(null), S = (0, a.useRef)(null), b = (0, a.useRef)(null), T = (0, a.useRef)(null), y = (0, a.useRef)(null), E = (0, a.useRef)(null), x = (0, a.useRef)(null), M = (0, a.useRef)(null), {
                        params: C,
                        passedParams: P,
                        rest: O,
                        events: k
                    ...
                    return (0, a.useEffect)(() => () => {
                        ...
                        return b.current = P, T.current = _, e.length && S.current && !S.current.destroyed && function(e) {
                            ...
                            u.includes("loop") && d.isElement && (w.loop && !p.loop ? a = !0 : !w.loop && p.loop ? n = !0 : o = !0), g.forEach(e => {
                                if (U(w[e]) && U(p[e])) Object.assign(w[e], p[e]), ("navigation" === e || "pagination" === e || "scrollbar" === e) && "enabled" in p[e] && !p[e].enabled && x(e);
                                else {
                                    let t = p[e];
                    ...
                    }, L["wrapper-start"], C.virtual ? function(e, t, i) {
                        if (!i) return null;
                        let s = e => {
                                let i = e;
                        ...
                        swiper: S.current,
                        swiperSlideIndex: t
                    })), L["wrapper-end"]), Z(C) && a.createElement(a.Fragment, null, a.createElement("div", {
                        ref: E,
                        className: "swiper-button-prev"
                    }), a.createElement("div", {
                        ref: y,
                        className: "swiper-button-next"
                    })), Q(C) && a.createElement("div", {
                        ref: M,
            ...
            en.displayName = "Swiper";
            let eo = (0, a.forwardRef)(function(e, t) {
                let {
                    tag: i = "div",
                    children: s,
                    className: r = "",
                    ...
                    swiperSlideIndex: c,
                    ...p
                } = void 0 === e ? {} : e, u = (0, a.useRef)(null), [h, f] = (0, a.useState)("swiper-slide"), [m, v] = (0, a.useState)(!1);

                function g(e, t, i) {
                    t === u.current && f(i)
                }
                er(() => {
                    if (void 0 !== c && (u.current.swiperSlideIndex = c), t && (t.current = u.current), u.current && l) {
                        if (l.destroyed) {
                ...
                }, p), n && a.createElement(el.Provider, {
                    value: w
                }, a.createElement("div", {
